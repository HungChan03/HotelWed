 ...
 * @author HP
 */
@WebServlet(name = "readPriceRoom", urlPatterns = {"/readPriceRoom"})
public class readPriceRoom extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(list!=null){
         request.setAttribute("data", list);
            request.getRequestDispatcher("readPriceRoom.jsp").forward(request, response);
        } else {
